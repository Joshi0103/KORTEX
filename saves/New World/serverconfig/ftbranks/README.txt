...
Last README file update: Sat Apr 08 21:44:13 CEST 2023
...
command.locate.mvs:abandonedlibrary
command.locate.mvs:acacialogpile
command.locate.mvs:azeleahouse
command.locate.mvs:barn
command.locate.mvs:basaltstatue
command.locate.mvs:beachbar
command.locate.mvs:beedome
command.locate.mvs:bigoaktree
command.locate.mvs:birchlogpile
command.locate.mvs:birchtree1
command.locate.mvs:birchtree2
command.locate.mvs:boulder
command.locate.mvs:calcitehouse
command.locate.mvs:campsite
command.locate.mvs:cart
command.locate.mvs:castleruins
command.locate.mvs:crimsonenchantingtable
command.locate.mvs:crystal
command.locate.mvs:darkoaklogpile
command.locate.mvs:deepslatehouse
command.locate.mvs:desertpump
command.locate.mvs:duck
command.locate.mvs:floatingislands
command.locate.mvs:flowerhole
command.locate.mvs:foxhut
command.locate.mvs:horsepen
command.locate.mvs:house
command.locate.mvs:island
command.locate.mvs:junglelogpile
command.locate.mvs:jungletower
command.locate.mvs:lampchest
command.locate.mvs:lavapool
command.locate.mvs:lecturngarden
command.locate.mvs:logruin
command.locate.mvs:mushroompond
command.locate.mvs:mushroomstatue
command.locate.mvs:netherdevil
command.locate.mvs:oaklogpile
command.locate.mvs:pond
command.locate.mvs:railway
command.locate.mvs:rarewell
command.locate.mvs:ruinedbeacon
command.locate.mvs:shed
command.locate.mvs:smallcopperwell
command.locate.mvs:smallruin
command.locate.mvs:smallswamphouse
command.locate.mvs:sprucelogpile
command.locate.mvs:stonebee
command.locate.mvs:stonefountain
command.locate.mvs:stonepillars
command.locate.mvs:sunzigate
command.locate.mvs:tallhouse
command.locate.mvs:treemonument
command.locate.mvs:villagerstatue
command.locate.mvs:warpedhouse
command.locate.mvs:well
